...
function Section({ name, checked, onCheckboxChange }){
    return(
        <section className="section">
            <CustomCheckbox className="chkSc" checked={checked} onChange={onCheckboxChange} />
            ...
            <span className="nameOfSection">{name}</span>
        </section>
    );
}
